...
import com.example.upg3backend.user.UserRepository;
import com.example.upg3backend.user.UserService;
...
public class PostController {
    ...
    @CrossOrigin
    @PutMapping("/create")
    public String createProduct(@RequestHeader("token") String token, @RequestBody Post posts, HttpServletResponse response) {
